vim.keymap.set({"n", "v"}, "<c-h>", "<c-w>h", { remap = true })
vim.keymap.set({"n", "v"}, "<c-l>", "<c-w>l", { remap = true })
vim.keymap.set({"n", "v"}, "<c-j>", "<c-w>j", { remap = true })
vim.keymap.set({"n", "v"}, "<c-k>", "<c-w>k", { remap = true })
vim.keymap.set({"n", "v"}, "<M-C-h>", "<c-w>h", { remap = true })
vim.keymap.set({"n", "v"}, "<M-C-l>", "<c-w>l", { remap = true })
vim.keymap.set({"n", "v"}, "<M-C-j>", "<c-w>j", { remap = true })
vim.keymap.set({"n", "v"}, "<M-C-k>", "<c-w>k", { remap = true })
vim.keymap.set({"t"}, "<M-C-h>", "<c-\\><c-n><c-w>h", { remap = true })
vim.keymap.set({"t"}, "<M-C-l>", "<c-\\><c-n><c-w>l", { remap = true })
vim.keymap.set({"t"}, "<M-C-j>", "<c-\\><c-n><c-w>j", { remap = true })
vim.keymap.set({"t"}, "<M-C-k>", "<c-\\><c-n><c-w>k", { remap = true })
