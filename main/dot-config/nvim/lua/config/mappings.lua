...
vim.keymap.set({"n", "v"}, "<C-S-h>", "<c-w>h", { remap = true })
vim.keymap.set({"n", "v"}, "<C-S-l>", "<c-w>l", { remap = true })
vim.keymap.set({"n", "v"}, "<C-S-j>", "<c-w>j", { remap = true })
vim.keymap.set({"n", "v"}, "<C-S-k>", "<c-w>k", { remap = true })
vim.keymap.set({"t"}, "<C-S-h>", "<c-\\><c-n><c-w>h", { remap = true })
vim.keymap.set({"t"}, "<C-S-l>", "<c-\\><c-n><c-w>l", { remap = true })
vim.keymap.set({"t"}, "<C-S-j>", "<c-\\><c-n><c-w>j", { remap = true })
