...
restart:bindOnce(hyper, "a", "Restart Alfred", function()
  hs.alert.show("Restart Alfred")
  local app = hs.application.get("Alfred")
  if app then app:kill() end
  hs.timer.doAfter(2, function() hs.application.open("Alfred 5") end)
end)
restart:bindOnce(hyper, "m", "Restart Mouseless", function()
  hs.alert.show("Restart Mouseless")
  local app = hs.application.get("Mouseless")
  if app then app:kill() end
  hs.timer.doAfter(2, function() hs.application.open("Mouseless") end)
end)
...
invoke:bindOnce({}, "b", "Alfred BTT Search", function() hs.osascript.applescript('tell application "Alfred" to search "btt "') end)
invoke:bindOnce({}, "t", "Alfred Top Search", function() hs.osascript.applescript('tell application "Alfred" to search "top "') end)
invoke:bindOnce({}, "y", "YouTube Search", function() hs.urlevent.openURL("raycast://extensions/tonka3000/youtube/search-videos?arguments=%7B%22query%22%3A%22%22%7D") end)
