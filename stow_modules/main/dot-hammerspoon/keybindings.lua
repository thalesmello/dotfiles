...
function M.setup()
  ...
  default:bindOnce(hyper, "a", "Open Muse.ai", function()
    task({"chrome-preset", "alternate-app", "--profile", "Default", "--minimize", "--app", "Muse.ai", "https://muse.ai/"})
  end)
  ...
  default:bindOnce(hyperShift, "d", "Focus WhatsApp (shift)", function()
    task({"chrome-preset", "alternate-app", "--profile", "Default", "--minimize", "--app", "WhatsApp", "https://web.whatsapp.com/"})
  end)
